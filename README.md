...
| | |
|---|---|
| **Sign-in ticket with SSO box** (workspace-slug SSO entry under the form — same torn-off ticket identity) | |
| ![SSO login ticket](docs/screenshots/sso-login-ticket.png) | |
...
```bash
cd backend
npm test                      # Vitest — 490 tests across 48 suites (2 skipped locally)
