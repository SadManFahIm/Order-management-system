...
### Roadmap (V2)
Customer storefront checkout (cart → order) · deeper analytics (retention cohorts, funnel, delivery perf) · SaaS admin portal · hardening (performance, observability, load) · production release.
