...
export const RESTAURANT_SEEDS = [
  {
    ...
    items: [
      { name: 'Hot & Crispy Chicken (2 pc)', price: 320, weight_gm: 350, description: 'Signature crispy fried chicken pieces' },
      { name: 'Zinger Burger', price: 260, weight_gm: 280, description: 'Crispy chicken fillet, mayo, fresh lettuce' },
      { name: 'Classic Fries', price: 150, weight_gm: 180, description: 'Golden crispy french fries' },
      { name: 'Colonel Combo', price: 620, weight_gm: 900, description: '2 pc chicken, fries, drink & a zinger wing' },
      { name: 'Mashed Potato with Gravy', price: 120, weight_gm: 200, description: 'Creamy mashed potato with hot gravy' },
      { name: 'Chicken Popcorn (Regular)', price: 180, weight_gm: 160, description: 'Bite-sized crispy chicken pops' },
    ],
  },
  {
    ...
    items: [
      { name: 'Margherita (Medium)', price: 650, weight_gm: 600, description: 'Tomato sauce, mozzarella, basil' },
      { name: 'Pepperoni Feast (Large)', price: 1150, weight_gm: 1000, description: 'Loaded pepperoni with extra cheese' },
      { name: 'Chicken Supreme (Medium)', price: 980, weight_gm: 650, description: 'Grilled chicken, capsicum, onion, mushroom' },
      { name: 'Garlic Breadsticks', price: 280, weight_gm: 300, description: 'Oven-baked with garlic butter' },
      { name: 'Spicy Chicken Wings (6 pc)', price: 420, weight_gm: 350, description: 'Tossed in tangy buffalo sauce' },
      { name: 'Choco Lava Cake', price: 220, weight_gm: 120, description: 'Warm chocolate molten cake' },
    ],
  },
  {
    name: "Domino's Pizza",
    ...
    items: [
      { name: 'Veggie Lover (Medium)', price: 590, weight_gm: 550, description: 'Onion, capsicum, tomato, mushroom' },
      { name: 'Chicken Tikka (Large)', price: 1050, weight_gm: 950, description: 'Spiced chicken tikka, onion, jalapeño' },
      { name: 'BBQ Chicken (Medium)', price: 890, weight_gm: 600, description: 'Smoky BBQ chicken, red onion' },
      { name: 'Garlic Cheese Bread', price: 260, weight_gm: 280, description: 'Cheese-filled bread with garlic dip' },
      { name: 'Choco Chunk Cookie', price: 180, weight_gm: 100, description: 'Warm, gooey chocolate chunk cookie' },
    ],
  },
  {
    name: 'Chillox',
    ...
    items: [
      { name: 'Chillox Beef Burger', price: 380, weight_gm: 420, description: 'Smash beef patty, secret sauce, pickles' },
      { name: 'Naga Blast Burger', price: 410, weight_gm: 430, description: 'Fiery naga-mayo, beef patty, jalapeños' },
      { name: 'Classic Fries with Cheese', price: 180, weight_gm: 250, description: 'Loaded fries with cheddar sauce' },
      { name: 'BBQ Chicken Wrap', price: 320, weight_gm: 380, description: 'Grilled chicken, BBQ sauce, fresh veggies' },
      { name: 'Thickshake (Chocolate)', price: 240, weight_gm: 400, description: 'Rich hand-spun chocolate shake' },
    ],
  },
  {
    name: 'Takeout',
  ...
  },
  {
    ...
    items: [
      { name: 'Kacchi (1 plate)', price: 450, weight_gm: 600, description: 'Fragrant basmati with mutton & potato' },
      { name: 'Chicken Roast', price: 320, weight_gm: 350, description: 'Slow-roasted whole chicken leg' },
      { name: 'Beef Tehari', price: 380, weight_gm: 550, description: 'Spiced beef with aromatic rice' },
      { name: 'Borhani', price: 80, weight_gm: 250, description: 'Traditional minty yogurt drink' },
      { name: 'Chicken Kacchi (1 plate)', price: 350, weight_gm: 550, description: 'Kacchi with tender chicken' },
    ],
  },
  {
    name: 'Star Kabab',
